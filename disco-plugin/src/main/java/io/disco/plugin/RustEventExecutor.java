...
/**
 * Generic dispatcher: implements both Listener (Bukkit's marker) and EventExecutor
 * so a single instance covers both arguments to PluginManager.registerEvent.
 *
...
public final class RustEventExecutor implements EventExecutor, Listener {
    ...
    public void execute(Listener listener, Event event) {
        dispatch(handlerId, event);
    }

    private static native void dispatch(long handlerId, Object event);
}
